...
describe('ConsoleLogger Specification', () => {
  it('Instantiate - constructor args are set', () => {
    const consoleLogger = new ConsoleLogger('ROOT',LoggerLevel.DEBUG,LoggerLevel.ENUMS,{},new JSONFormatter(), new CachingConsole(10,true))
  ...
  it('Instantiate - default constructor args are set', () => {
    const logger = new DelegatingLogger(null);

    assert.equal(logger.provider, null, 'logger.provider === null');
  });

  it('setLevel', () => {
    const logger = new DelegatingLogger(new ConsoleLogger('ROOT',LoggerLevel.DEBUG,LoggerLevel.ENUMS,{},new JSONFormatter(),new CachingConsole(10,true)));
  ...
  it('Check levels - verbose', () => {
    const logger = new DelegatingLogger(new ConsoleLogger('ROOT',LoggerLevel.VERBOSE,LoggerLevel.ENUMS,{},new JSONFormatter(),new CachingConsole(10,true)));
  ...
  it('Check levels - info', () => {
    const logger = new DelegatingLogger(new ConsoleLogger('ROOT',LoggerLevel.INFO,LoggerLevel.ENUMS,{},new JSONFormatter(),new CachingConsole(10,true)));
    assert.isFalse(logger.isLevelEnabled(LoggerLevel.DEBUG), 'Debug is false');
  ...
  it('Check levels - warn', () => {
    const logger = new DelegatingLogger(new ConsoleLogger('ROOT',LoggerLevel.WARN,LoggerLevel.ENUMS,{},new JSONFormatter(),new CachingConsole(10,true)));
    assert.isFalse(logger.isLevelEnabled(LoggerLevel.DEBUG), 'Debug is false');
    assert.isFalse(logger.isLevelEnabled(LoggerLevel.VERBOSE), 'Verbose is false');
  ...
  it('Check levels - error', () => {
    const logger = new DelegatingLogger(new ConsoleLogger('ROOT',LoggerLevel.ERROR,LoggerLevel.ENUMS,{},new JSONFormatter(),new CachingConsole(10,true)));
    assert.isFalse(logger.isLevelEnabled(LoggerLevel.DEBUG), 'Debug is false');
    assert.isFalse(logger.isLevelEnabled(LoggerLevel.VERBOSE), 'Verbose is false');
    assert.isFalse(logger.isLevelEnabled(LoggerLevel.INFO), 'Info is false');
  ...
  it('Check levels - fatal', () => {
    const logger = new DelegatingLogger(new ConsoleLogger('ROOT',LoggerLevel.FATAL,LoggerLevel.ENUMS,{},new JSONFormatter(),new CachingConsole(10,true)));
    assert.isFalse(logger.isLevelEnabled(LoggerLevel.DEBUG), 'Debug is false');
    assert.isFalse(logger.isLevelEnabled(LoggerLevel.VERBOSE), 'Verbose is false');
    assert.isFalse(logger.isLevelEnabled(LoggerLevel.INFO), 'Info is false');
    assert.isFalse(logger.isLevelEnabled(LoggerLevel.WARN), 'Warn is false');

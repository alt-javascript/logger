...
describe('WinstonLogger Specification', () => {
  ...
  it('setLevel', () => {
    const logger = new WinstonLogger(
      Logger.DEFAULT_CATEGORY, LoggerLevel.DEBUG, LoggerLevel.ENUMS, {}, winston,
    );
  ...
  it('Check levels - verbose', () => {
    const logger = new WinstonLogger(
      Logger.DEFAULT_CATEGORY, LoggerLevel.VERBOSE, LoggerLevel.ENUMS, {}, winston,
    );
  ...
  it('Check levels - info', () => {
    const logger = new WinstonLogger(
      Logger.DEFAULT_CATEGORY, LoggerLevel.INFO, LoggerLevel.ENUMS, {}, winston,
    );
    assert.isFalse(logger.isLevelEnabled(LoggerLevel.DEBUG), 'Debug is false');
  ...
  it('Check levels - warn', () => {
    const logger = new WinstonLogger(
      Logger.DEFAULT_CATEGORY, LoggerLevel.WARN, LoggerLevel.ENUMS, {}, winston,
    );
    assert.isFalse(logger.isLevelEnabled(LoggerLevel.DEBUG), 'Debug is false');
    assert.isFalse(logger.isLevelEnabled(LoggerLevel.VERBOSE), 'Verbose is false');
  ...
  it('Check levels - error', () => {
    const logger = new WinstonLogger(
      Logger.DEFAULT_CATEGORY, LoggerLevel.ERROR, LoggerLevel.ENUMS, {}, winston,
    );
    assert.isFalse(logger.isLevelEnabled(LoggerLevel.DEBUG), 'Debug is false');
    assert.isFalse(logger.isLevelEnabled(LoggerLevel.VERBOSE), 'Verbose is false');
    assert.isFalse(logger.isLevelEnabled(LoggerLevel.INFO), 'Info is false');
  ...
  it('Check levels - fatal', () => {
    const logger = new WinstonLogger(
      Logger.DEFAULT_CATEGORY, LoggerLevel.FATAL, LoggerLevel.ENUMS, {}, winston,
    );
    assert.isFalse(logger.isLevelEnabled(LoggerLevel.DEBUG), 'Debug is false');
    assert.isFalse(logger.isLevelEnabled(LoggerLevel.VERBOSE), 'Verbose is false');
    assert.isFalse(logger.isLevelEnabled(LoggerLevel.INFO), 'Info is false');

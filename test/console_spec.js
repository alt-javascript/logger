...
const logger = LoggerFactory.getLogger('@alt-javascript/logger/test/console_spec',config);
...
const verbose = LoggerFactory.getLogger('@alt-javascript/logger/test/console_spec/verbose',config);
